...
export default function ForgotPasswordReset({ email, onSubmit, isLoading }) {
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pl-12 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.password ? "border-red-500" : "border-gray-300"
                  }`}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 pl-12 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.confirmPassword ? "border-red-500" : "border-gray-300"
                  }`}
