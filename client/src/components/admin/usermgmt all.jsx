                    ...
                    <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 p-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <div className="relative">
                                ...
                                {selectedUser.isServiceVerified || true && (
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl p-6 border border-purple-100">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        ...
                                        <p className="font-mono text-sm bg-white px-2 py-1 rounded border">{selectedUser.userId}</p>
                                    </div>
                                    <div>
                            ...
                            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-6 border border-cyan-100 lg:col-span-2">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                                    <div className="bg-white rounded-xl p-4 text-center shadow-sm border">
                                        <div className="text-2xl font-bold text-gray-900">{selectedUser.totalServiceRequests}</div>
                                        <div className="text-sm text-gray-500 mt-1">Total Requests</div>
                                    </div>
                                    <div className="bg-white rounded-xl p-4 text-center shadow-sm border">
                                        <div className="text-2xl font-bold text-green-600">{selectedUser.totalServiceCompleted}</div>
                                        <div className="text-sm text-gray-500 mt-1">Completed</div>
                                    </div>
                                    <div className="bg-white rounded-xl p-4 text-center shadow-sm border">
                                        <div className="text-2xl font-bold text-blue-600">{selectedUser.totalServiceInProgress}</div>
                                        <div className="text-sm text-gray-500 mt-1">In Progress</div>
                                    </div>
                                    <div className="bg-white rounded-xl p-4 text-center shadow-sm border">
                                        <div className="text-2xl font-bold text-yellow-600">{selectedUser.totalServicePending}</div>
                                        <div className="text-sm text-gray-500 mt-1">Pending</div>
                                    </div>
                                    <div className="bg-white rounded-xl p-4 text-center shadow-sm border">
                                        <div className="text-2xl font-bold text-red-600">{selectedUser.totalServiceCancelled}</div>
                            ...
                            <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-2xl p-6 border border-gray-200">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-mono text-sm bg-white px-2 py-1 rounded border">{selectedUser.lastLoginIp}</p>
                                    </div>
                                </div>
                            </div>
